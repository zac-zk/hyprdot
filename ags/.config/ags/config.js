            ...
            connections: [
                [
                    ...
                    (self) => {
                        ...
                        arr = arr.filter(item => workspacesObj.hasOwnProperty(item)).sort((a, b) => {
                            return Object.keys(workspacesObj).indexOf(a) - Object.keys(workspacesObj).indexOf(b);
                        });
                        self.children = arr.map((i) =>
                            Widget.Button({
                                onClicked: sh(`hyprctl dispatch workspace ${i}`),
                                child: Widget.Label(workspacesObj[i]),
                                className: Hyprland.active.workspace.name == i ? "focused" : "",
                            })
                        );
                    },
                ],
